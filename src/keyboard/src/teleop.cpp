...
#include <keyboard/ThrusterConfig.h>
...
void dyn_cb(keyboard::ThrusterConfig &config,uint32_t level)
{
	configArr[0] = config.speed1;
	configArr[1] = config.speed2;
	configArr[2] = config.speed3;
	configArr[3] = config.speed4;
	configArr[4] = config.speed5;
	configArr[5] = config.speed6;
	configArr[6] = config.speed7;
	configArr[7] = config.speed8;
	/*for(int i=0;i<8;i++)
	{
		ROS_INFO("CONFIG %d : %d",i,configArr[i]);
	}*/
}
int main(int argc,char** argv){
  ros::init(argc,argv,"teleop_sedna");
  ros::NodeHandle nh;
  dynamic_reconfigure::Server<keyboard::ThrusterConfig> server;
  dynamic_reconfigure::Server<keyboard::ThrusterConfig>::CallbackType f;
...
thruster.speeddir2 = 1500;
  ...
  thrusterPub = nh.advertise<srmauv_msgs::thruster_alp>("/thruster",1000);
  modePub =  nh.advertise<srmauv_msgs::control_mode>("/mode",1000);
  ...
  switch(key->code){
   ...
   case 99:
	...
	case 119:{
		...
		thruster.speedup1 = 1500+configArr[0];
		thruster.speedup2 = 1500+configArr[1];
		thruster.speedup3 = 1500+configArr[4];
		thruster.speedup4 = 1500+configArr[5];
		ROS_INFO("pressed");
		break;
	}
	...
	break;
      ...
      case 273: { // forward
        thruster.speedfwd1 = 1500+configArr[2];
	thruster.speedfwd2 = 1500+configArr[3];
	...
	thruster.speedfwd2 = 1500-configArr[3];
      ...
      case 276 :{ //left
        ...
        thruster.speeddir1 = 1500+configArr[6];
	thruster.speeddir2 = 1500+configArr[7];
	
        break;
      }
      case 275 :{
        thruster.speeddir2 = 1500-configArr[6];
	thruster.speeddir1 = 1500-configArr[7];
        break;
      }
