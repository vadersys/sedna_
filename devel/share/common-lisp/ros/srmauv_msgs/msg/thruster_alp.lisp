...
(cl:defmethod drop-val ((m <thruster_alp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader srmauv_msgs-msg:drop-val is deprecated.  Use srmauv_msgs-msg:drop instead.")
  (drop m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <thruster_alp>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'drop) 1 0)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <thruster_alp>) istream)
  "Deserializes a message object of type '<thruster_alp>"
    (cl:setf (cl:slot-value msg 'drop) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:let ((unsigned 0))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<thruster_alp>)))
  ...
  "edf26f34762cfc32025abd91efe7f990")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'thruster_alp)))
  "Returns md5sum for a message object of type 'thruster_alp"
  "edf26f34762cfc32025abd91efe7f990")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<thruster_alp>)))
  ...
  (cl:format cl:nil "bool drop~%~%int16 speedfwd1~%int16 speedfwd2~%int16 speedup1~%int16 speedup2~%int16 speedup3~%int16 speedup4~%int16 speeddir1~%int16 speeddir2~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'thruster_alp)))
  "Returns full string definition for message of type 'thruster_alp"
  (cl:format cl:nil "bool drop~%~%int16 speedfwd1~%int16 speedfwd2~%int16 speedup1~%int16 speedup2~%int16 speedup3~%int16 speedup4~%int16 speeddir1~%int16 speeddir2~%~%~%~%"))
