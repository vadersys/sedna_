...
"""autogenerated by genpy from smach_/sinkActionFeedback.msg. Do not edit."""
import sys
...
class sinkActionFeedback(genpy.Message):
  _md5sum = "c9bb172238b5d87f1a17b1b1bfbf52c7"
  _type = "smach_/sinkActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','smach_/sinkFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(sinkActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = smach_.msg.sinkFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = smach_.msg.sinkFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_I.pack(self.feedback.cur_depth))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.cur_depth,) = _struct_I.unpack(str[start:end])
      return self
