...
"""autogenerated by genpy from smach_/sinkActionResult.msg. Do not edit."""
import sys
...
class sinkActionResult(genpy.Message):
  _md5sum = "84480dfc524d0646adbae30234f7ba8c"
  _type = "smach_/sinkActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','smach_/sinkResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(sinkActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = smach_.msg.sinkResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = smach_.msg.sinkResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_I.pack(self.result.pose))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.pose,) = _struct_I.unpack(str[start:end])
      return self
